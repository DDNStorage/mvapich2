...
int MV2_set_ireduce_tuning_table(int heterogeneity)
{
	...
	mv2_ireduce_thresholds_table = MPIU_Malloc(mv2_size_ireduce_tuning_table *
						  sizeof (mv2_ireduce_tuning_table));
	mv2_ireduce_tuning_table mv2_tmp_ireduce_thresholds_table[] = {
	    {8,
	     8192, 4, 4,
	     {0},
	     1, {{0, -1, &MPIR_Ireduce_binomial, -1}},
	     1, {{0, -1, NULL, -1}}
	    },
	    {16,
	     8192, 4, 4,
      ...
      MPIU_Memcpy(mv2_ireduce_thresholds_table, mv2_tmp_ireduce_thresholds_table,
...
void MV2_cleanup_ireduce_tuning_table()
{
	...
	MPIU_Free(mv2_ireduce_thresholds_table);
    }
...
int MV2_internode_Ireduce_is_define(char *mv2_user_ireduce_inter, char *mv2_user_ireduce_intra)
{
	...
	if (!(dup = MPIU_Strdup(mv2_user_ireduce_inter))) {
    ...
    MPIU_Memcpy(mv2_ireduce_thresholds_table, mv2_tmp_ireduce_thresholds_table, sizeof
